...
impl<S: OutputPin, D: OutputPin> StepperOps for StepperMotor<S,D>{
    ...
    fn step(&mut self, steps: i32, ignore_max_steps: bool, serial: &mut Usart0<MHz16>) -> Result<i32, StepperOpsError> {
        ...
        ufmt::uwriteln!(serial, "Step command {}", steps);
        ...
        ufmt::uwriteln!(serial, "New current step {}", self.current_step);
    ...
    fn micro_step(&mut self, _steps: i32, serial: &mut Usart0<MHz16>) -> Result<i32, StepperOpsError> {
        unimplemented!()
    }
    ...
    fn to_step(&mut self, step: i32, serial: &mut Usart0<MHz16>) -> Result<i32, StepperOpsError> {
        ...
        ufmt::uwriteln!(serial, "To step to {}, from {} to {}", steps, self.current_step(), step);
